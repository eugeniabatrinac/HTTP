...
public class HttpURLConnectionSample {
	...
	public static void main(String[] args) throws Exception {
		...
		HttpURLConnectionSample http = new HttpURLConnectionSample();
		...
		System.out.println("\nTesting 5 - Send Http PATCH request");
		http.sendPatch();
	...
	private void sendPost() throws Exception {
		...
		String urlParameters = "name=edward&job=developer";
	...
	private void sendPut() throws Exception {
		...
		String urlParameters = "name=edward&job=software%20developer";
